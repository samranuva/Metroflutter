...
class NeighbourhoodAreasScreen extends StatefulWidget {
  const NeighbourhoodAreasScreen({super.key});

  @override
  State<NeighbourhoodAreasScreen> createState() => _NeighbourhoodAreasScreenState();
}

class _NeighbourhoodAreasScreenState extends State<NeighbourhoodAreasScreen> {
  String selectedGate = 'Gate A';
  final List<String> gates = ['Gate A', 'Gate B', 'Gate C', 'Gate D'];
